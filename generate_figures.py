...
def RT_comparison(file_path = "figures/new_figures/"):
    db_optimimzed_algos_plusTSP = [
        ...
        {"algo": scheduling_DB_STF_optimized,    "label": "DB-STF",        "line": "k-"},
        {"algo": scheduling_DB_LTF_optimized,    "label": "DB-LTF",        "line": "b-"},
        {"algo": scheduling_TSP,                 "label": "DB-TSP",        "line": "r-"}]
    ...
    plot_total_recharge_time(algos=db_optimimzed_algos_plusTSP, file_name = file_path + "RT_DBLP_DB_ALGOS.eps", fig_title="DB-LP + DB Algorithms", legend_style=1)
...
def DB_versus_SB(file_path = "figures/new_figures/"):
    ...
    db_wt  = {"algo": scheduling_DB_WT_optimized,       "label": "DB-LP + DB-WT",       "line": "r-"}
    ...
    sb_wt  = {"algo": scheduling_SB_WT_revised,         "label": "SB-LP + SB-WT",       "line": "b-"}
